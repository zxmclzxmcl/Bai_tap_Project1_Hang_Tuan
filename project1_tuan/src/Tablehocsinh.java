...
public class Tablehocsinh implements Initializable{
    ...
    void Add(ActionEvent event) {
        ...
        if (HovaTen.getText() != "" && QueQuan.getText() != "" && Tuoi.getText() != ""){
        ...
        //     //clear the TextField
            ...
            alert.setHeaderText("Vui lòng nhập đủ họ tên, quê quán và số tuổi của học sinh");
            alert.showAndWait();
    ...
    @FXML
    void bttuan(ActionEvent event) throws IOException {
        Stage stage;
        Scene scene;
        Parent root;

        root = FXMLLoader.load(getClass().getResource("menutuan.fxml"));
